...
const (
	Category_ListCategory_FullMethodName = "/api.kratosblog.server.v1.Category/ListCategory"
)
...
var Category_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.kratosblog.server.v1.Category",
	...
	Metadata: "api/kratosblog/server/v1/category.proto",
}
