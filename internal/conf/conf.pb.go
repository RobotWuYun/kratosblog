...
type Server struct {
	...
	AseKey string       `protobuf:"bytes,3,opt,name=ase_key,json=aseKey,proto3" json:"ase_key,omitempty"`
}
...
func (x *Server) GetAseKey() string {
	if x != nil {
		return x.AseKey
	}
	return ""
...
func (x *Data) GetRepository() *Repository {
	if x != nil {
		return x.Repository
	}
	return nil
...
type Repository struct {
	...
	PrivateSuffix string `protobuf:"bytes,2,opt,name=private_suffix,json=privateSuffix,proto3" json:"private_suffix,omitempty"`
}
...
func (x *Repository) GetPrivateSuffix() string {
	if x != nil {
		return x.PrivateSuffix
	}
	return ""
}
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x69, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0xd1, 0x02, 0x0a,
	...
	0x63, 0x12, 0x17, 0x0a, 0x07, 0x61, 0x73, 0x65, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x06, 0x61, 0x73, 0x65, 0x4b, 0x65, 0x79, 0x1a, 0x69, 0x0a, 0x04, 0x48, 0x54,
	...
	0x22, 0x95, 0x03, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x35, 0x0a, 0x08, 0x64, 0x61, 0x74,
	...
	0x61, 0x2e, 0x52, 0x65, 0x64, 0x69, 0x73, 0x52, 0x05, 0x72, 0x65, 0x64, 0x69, 0x73, 0x12, 0x36,
	...
	0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x1a, 0x3a, 0x0a, 0x08, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61,
	...
	0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0x47, 0x0a, 0x0a, 0x52, 0x65, 0x70, 0x6f,
	0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61, 0x74, 0x68, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x61, 0x74, 0x68, 0x12, 0x25, 0x0a, 0x0e, 0x70, 0x72,
	0x69, 0x76, 0x61, 0x74, 0x65, 0x5f, 0x73, 0x75, 0x66, 0x66, 0x69, 0x78, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x0d, 0x70, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x53, 0x75, 0x66, 0x66, 0x69,
	0x78, 0x42, 0x1f, 0x5a, 0x1d, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x62, 0x6c, 0x6f, 0x67, 0x2f,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Repository)(nil),          // 3: kratos.api.Repository
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	3,  // 6: kratos.api.Data.repository:type_name -> kratos.api.Repository
